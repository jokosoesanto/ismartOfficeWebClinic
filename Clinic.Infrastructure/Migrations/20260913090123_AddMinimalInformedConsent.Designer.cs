...
namespace Clinic.Infrastructure.Migrations
{
    ...
    [Migration("20260913090123_AddMinimalInformedConsent")]
    partial class AddMinimalInformedConsent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.MasterData.ConditionMaster", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ConditionMasters", (string)null);
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.MasterData.PatientMedication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.MasterData.TreatmentCatalog", b =>
                {
                    ...
                    b.HasIndex("SubCategoryId", "TreatmentName")
                        .IsUnique()
                        .HasFilter("[IsDeleted] = 0");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.MasterData.TreatmentCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.MasterData.TreatmentSubCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("TreatmentSubCategories", (string)null);
                });
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Operations.AppointmentTreatment", b =>
                {
                    ...
                    b.Property<Guid>("TreatmentItemId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Operations.DoctorLeaveDate", b =>
                {
                    ...
                    b.Property<Guid>("DoctorLeaveRequestId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("DoctorLeaveRequestId", "Date")
                        .IsUnique();

                    b.ToTable("DoctorLeaveDates", (string)null);
                });
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Operations.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Operations.InvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Operations.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.MasterData.Insurance", b =>
                {
                    b.HasOne("Clinic.Domain.Entities.System.MasterReference", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.MasterData.TreatmentCatalog", b =>
                {
                    ...
                    b.HasOne("Clinic.Domain.Entities.System.MasterReference", "ServiceType")
                        .WithMany()
                        .HasForeignKey("ServiceTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Clinic.Domain.Entities.MasterData.TreatmentSubCategory", "SubCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Operations.Appointment", b =>
                {
                    b.HasOne("Clinic.Domain.Entities.MasterData.Chair", "Chair")
                        .WithMany()
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Operations.AppointmentTreatment", b =>
                {
                    ...
                    b.HasOne("Clinic.Domain.Entities.MasterData.TreatmentCatalog", "TreatmentItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Operations.DoctorLeaveDate", b =>
                {
                    b.HasOne("Clinic.Domain.Entities.Operations.DoctorLeaveRequest", "DoctorLeaveRequest")
                        .WithMany("LeaveDates")
                        .HasForeignKey("DoctorLeaveRequestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DoctorLeaveRequest");
                });
            ...
            modelBuilder.Entity("Clinic.Domain.Entities.Operations.InvoiceLine", b =>
                {
                    b.HasOne("Clinic.Domain.Entities.Operations.AppointmentTreatment", "AppointmentTreatment")
                        .WithMany()
                        .HasForeignKey("AppointmentTreatmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Clinic.Domain.Entities.Operations.Invoice", "Invoice")
